...
@property (weak, nonatomic) IBOutlet UILabel *deserveLabel;

@property (weak, nonatomic) IBOutlet UILabel *fastFiveLabel;
@property (weak, nonatomic) IBOutlet UILabel *fastTenLabel;
